...
def signup():
    print("Please enter the username for registration")
...
def task_information(username):
    ...
    for i in range(1, j + 1):
        ...
        f1.write(target)
        f1.write('\n')
        print("Do u want to stop press (Space Bar) otherwise press  (Enter)")
        s = input()
        if s == ' ':
            break
    f1.close()
...
if __name__ == '__main__':
    print("WELCOME TO PRASAD'S TASK MANAGER")
